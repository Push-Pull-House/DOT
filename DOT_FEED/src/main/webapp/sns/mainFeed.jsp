...
<link rel="stylesheet" type="text/css"
	href="${contextPath}/resources/css/slick.css" />
...
<script type="text/javascript"
	src="${contextPath}/resources/js/MainFeed.js"></script>
<script type="text/javascript"
																	...
																	<dt>
																		...
																		<c:forEach var="fr" items="${fr}">
																			<c:forEach var="fw" items="${fw}">
																				<c:if
																					test="${i.feedWriter eq fr.friendUser1 && i.feedWriter eq fw.friendUser2}">
																					<c:set var="div5">
												...
												<div class="feed-body">
													...
													<div class="body-bottom">
														...
														<div class="feed-content">
															<span class="bold"> <c:forEach var="f"
																	items="${pf}">
...
/* 				 $(".bookmark-control-js").click(function(){
				...
				<div class="modal-body modal-backgound">
					<div class="modal-feed-body">
						<div class="feed-img">
							...
							<div>
								<img
									src="${contextPath}/resources/images/—Pngtree—user icon_5097430.png" />
							</div>
						</div>
						<div class="body-bottom">
							<div class="feed-tools">
						...
						<div class="lists">
							<div class="follower-list">
								<div>
									<dl>
										<dt>
											<img src="${contextPath}/resources/images/karina2.jpeg" /> <span>karina_1211</span>
											<input type="checkbox" />
										</dt>
										<dt>
											<img src="${contextPath}/resources/images/karina2.jpeg" /> <span>karina_1211</span>
