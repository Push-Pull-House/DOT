...
<script>
	...
	$(function(e) {
	    ...
	    chatRoomStompClient = Stomp.over(socket);
		
	    
	    chatRoomStompClient.connect({}, () => {
	        // 한 번만 구독을 설정합니다.
	        chatRoomStompClient.subscribe('/dot/chat', (message) => {
	        ...
	        function sendMessage() {
	            ...
	            if (inputChatting.value.trim().length == 0) {
	                ...
	                // 메시지 보내기
	                chatRoomStompClient.send('/chat/chatRoomList/' + chatRoomNo, {}, JSON.stringify(chatMessage));
	            }
	        }
